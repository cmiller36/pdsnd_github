...
def get_filters():
    ...
    while True :
        city = input('Select a city to explore. Please choose: Chicago, New York City, or Washington\n').lower()
        if city.lower() not in CITIES:
            print("Sorry, please select your city again.")
            continue
        else:
            break
...
def get_filters():
    ...
    while True :
        city = input('Select a city to explore. Please choose: Chicago, New York City, or Washington\n').lower()
        if city.lower() not in CITIES:
            print("City not found, please select your city again.")
            continue
        else:
            break
